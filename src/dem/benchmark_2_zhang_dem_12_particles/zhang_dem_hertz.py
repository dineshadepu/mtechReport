...
from pysph.sph.rigid_body import (BodyForce, HertzRigidBody,
...
class BallBouncing(Application):
    ...
    def create_particles(self):
        ...
        add_properties(temp_wall, 'youngs')
        add_properties(temp_wall, 'poisson')
        temp_wall.rad_s[:] = (0.5 * 1e-3)
        temp_wall.poisson[:] = 0.3
        temp_wall.youngs[:] = 69 * 1e9
